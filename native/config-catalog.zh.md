<!-- 英文源文件由 scripts/gen-config-catalog.ts 生成；本中文文件是通過雙語配對維護的經評審對側。
     更新時先運行 `pnpm run gen-config-catalog` 更新英文，再更新本文件并運行 `pnpm run verify-translation-pairing --write docs/config-catalog.md` 重新記錄配對。 -->

# 插件配置目錄

[English](config-catalog.md) | 中文

每個 `config:` 塊均可由 `cordis.yml` 條目設置：針對每個可加載的 harness 包，原樣列出其 `apply` 函數或服務構造函數接收的配置聲明（包括 JSDoc），并附上所有引用類型——包內類型直接粘貼，其他類型則提供鏈接。粘貼的內容是插件聲明的完整配置類型——運行時 schema 有意排除的字段是僅供運行時使用的 seam（其自身的 JSDoc 會如此說明），不能通過 `cordis.yml` 設置。這是以**部署**為軸的參考文檔——插件作者所依據的連接方式請參閱各[子系統頁面](subsystems/core.zh.md)中的生成 `cordis-surface` 區域，面向模型的工具 schema 請參閱[工具目錄](tool-catalog.zh.md)，而 [subsystems/](subsystems/core.zh.md) 則記錄了這些聲明所引用的類型。

英文源文件由源代碼（`scripts/gen-config-catalog.ts`）生成，并通過 `pnpm run verify-config-catalog`（`doc-sync` 的一部分）驗證新鮮度；本中文文件作為經評審對側通過雙語配對維護。聲明塊使用 `ts config-catalog` 圍欄（doc-typecheck 會跳過它，因為單獨引用導入項的聲明無法獨立編譯）。英文生成器還會將運行時 schemastery schema 與粘貼的聲明進行交叉核對——每個經 schema 驗證的鍵（包括嵌套鍵）都必須能在聲明的配置類型中找到——因此，粘貼內容無法隱藏加載器接受的字段。

`Requires:` 行列出插件通過 `inject` 注入的服務鍵：其 `cordis.yml` 樹還必須加載這些服務的提供者。范圍限定為 harness 層級（`packages/`）；配置樹還可能加載的 vendored cordis 插件（`hmr`、控制臺日志記錄器等）固定為上游源代碼（參見 [vendoring policy](../vendor/README.md)），未收錄于此目錄。
...
依賴：`Stream`（`@agentclientprotocol/sdk`）

來源：[`packages/acp/acp/src/index.ts:75`](../packages/acp/acp/src/index.ts)
...
來源：[`packages/core/agent-default-model/src/index.ts:41`](../packages/core/agent-default-model/src/index.ts)
...
來源：[`packages/context/agent-instructions/src/config.ts:18`](../packages/context/agent-instructions/src/config.ts)
...
依賴：[`AgentOptions`](subsystems/core.zh.md) · [`SessionId`](subsystems/core.zh.md)

來源：[`packages/core/agent-loop/src/index.ts:318`](../packages/core/agent-loop/src/index.ts)
...
來源：[`packages/preset/agent-presets/src/preset.ts:52`](../packages/preset/agent-presets/src/preset.ts)
...
依賴：[`ToolPresentationMode`](subsystems/tools.zh.md)

來源：[`packages/core/agent-tool-presentation/src/index.ts:38`](../packages/core/agent-tool-presentation/src/index.ts)
...
來源：[`packages/api/gateway/src/index.ts:119`](../packages/api/gateway/src/index.ts)
...
來源：[`packages/api/session-controller/src/index.ts:69`](../packages/api/session-controller/src/index.ts)
...
來源：[`packages/api/settings-controller/src/index.ts:36`](../packages/api/settings-controller/src/index.ts)
...
來源：[`packages/api/workspace-files/src/index.ts:69`](../packages/api/workspace-files/src/index.ts)
...
來源：[`packages/attachment/attachment-local/src/index.ts:61`](../packages/attachment/attachment-local/src/index.ts)
...
來源：[`packages/shell/bash-local/src/index.ts:41`](../packages/shell/bash-local/src/index.ts)
...
依賴：[`LocalConfig`](#deepseek-aidsh-bash-local)

來源：[`packages/shell/bash-sandbox/src/index.ts:36`](../packages/shell/bash-sandbox/src/index.ts)
...
來源： [`packages/client/connection/src/index.ts:72`](../packages/client/connection/src/index.ts)
...
來源：[`packages/client/hmr/src/index.ts:31`](../packages/client/hmr/src/index.ts)
...
來源：[`packages/code-runtime/code-runtime-worker-thread/src/index.ts:25`](../packages/code-runtime/code-runtime-worker-thread/src/index.ts)
...
來源：[`packages/compaction/compaction-basic/src/types.ts:38`](../packages/compaction/compaction-basic/src/types.ts)
...
來源：[`packages/compaction/compaction-tool-result-pruner/src/types.ts:5`](../packages/compaction/compaction-tool-result-pruner/src/types.ts)
...
來源：[`packages/extensions/cordis-host-runner/src/index.ts:88`](../packages/extensions/cordis-host-runner/src/index.ts)
...
來源：[`packages/credentials/credentials-local/src/index.ts:64`](../packages/credentials/credentials-local/src/index.ts)
...
來源：[`packages/e2b/e2b/src/index.ts:45`](../packages/e2b/e2b/src/index.ts)
...
來源：[`packages/experimental/agent-team/src/types.ts:130`](../packages/experimental/agent-team/src/types.ts)
...
來源：[`packages/experimental/code-runtime-python/src/index.ts:42`](../packages/experimental/code-runtime-python/src/index.ts)
...
來源：[`packages/experimental/inspector/src/index.ts:66`](../packages/experimental/inspector/src/index.ts)
...
來源：[`packages/experimental/tool-agent-team/src/index.ts:17`](../packages/experimental/tool-agent-team/src/index.ts)
...
來源：[`packages/context/file-reference-local/src/index.ts:34`](../packages/context/file-reference-local/src/index.ts)
...
來源：[`packages/fs/fs-local/src/index.ts:42`](../packages/fs/fs-local/src/index.ts)
...
依賴：[`LocalConfig`](#deepseek-aidsh-fs-local)

來源：[`packages/fs/fs-sandbox/src/index.ts:45`](../packages/fs/fs-sandbox/src/index.ts)
...
來源：[`packages/goal/goal/src/index.ts:172`](../packages/goal/goal/src/index.ts)
...
來源：[`packages/bundle/headless/src/index.ts:34`](../packages/bundle/headless/src/index.ts)
...
來源：[`packages/hooks/hooks-claude-code/src/index.ts:44`](../packages/hooks/hooks-claude-code/src/index.ts)
...
來源：[`packages/hooks/hooks-codex/src/index.ts:43`](../packages/hooks/hooks-codex/src/index.ts)
...
來源：[`packages/host/directory-picker-browse/src/index.ts:181`](../packages/host/directory-picker-browse/src/index.ts)
...
來源：[`packages/host/frontend-static/src/index.ts:30`](../packages/host/frontend-static/src/index.ts)
...
來源：[`packages/host/open-in-app/src/index.ts:50`](../packages/host/open-in-app/src/index.ts)
...
來源：[`packages/host/webserver/src/index.ts:59`](../packages/host/webserver/src/index.ts)
...
來源：[`packages/runtime-diagnostics/invariants/src/index.ts:15`](../packages/runtime-diagnostics/invariants/src/index.ts)
...
來源：[`packages/jobs/jobs-local/src/index.ts:31`](../packages/jobs/jobs-local/src/index.ts)
...
依賴：[`ModelModality`](../packages/llm/llm/src/index.ts) · [`RetryPolicyConfig`](../packages/llm/llm/src/index.ts) · [`SystemPromptUpdate`](../packages/llm/llm/src/index.ts)

來源：[`packages/llm/llm-deepseek/src/index.ts:134`](../packages/llm/llm-deepseek/src/index.ts)
...
依賴：`Api`（`@earendil-works/pi-ai`）· `CacheRetention`（`@earendil-works/pi-ai`）· `Model`（`@earendil-works/pi-ai`）· `ModelThinkingLevel`（`@earendil-works/pi-ai`）· `OpenAICompletionsCompat`（`@earendil-works/pi-ai`）· [`RetryPolicyConfig`](../packages/llm/llm/src/index.ts) · `ThinkingBudgets`（`@earendil-works/pi-ai`）· `Transport`（`@earendil-works/pi-ai`)

來源：[`packages/llm/llm-pi-ai/src/config.ts:221`](../packages/llm/llm-pi-ai/src/config.ts)
...
來源：[`packages/test-support/llm-replay/src/index.ts:1123`](../packages/test-support/llm-replay/src/index.ts)
...
來源：[`packages/llm/llm-retry/src/index.ts:25`](../packages/llm/llm-retry/src/index.ts)
...
來源：[`packages/lsp/lsp-stdio/src/index.ts:82`](../packages/lsp/lsp-stdio/src/index.ts)
...
來源：[`packages/mcp/mcp-client/src/index.ts:98`](../packages/mcp/mcp-client/src/index.ts)
...
來源：[`packages/feedback/message-feedback/src/index.ts:40`](../packages/feedback/message-feedback/src/index.ts)
...
依賴：[`ApprovalPolicy`](subsystems/approval.zh.md) · [`SandboxMode`](subsystems/sandbox.zh.md)

來源：[`packages/interaction/permission-presets/src/index.ts:144`](../packages/interaction/permission-presets/src/index.ts)
...
來源：[`packages/preset/persona/src/index.ts:30`](../packages/preset/persona/src/index.ts)
...
來源：[`packages/plan/plan-mode/src/index.ts:64`](../packages/plan/plan-mode/src/index.ts)
...
來源：[`packages/llm/plugin-package-inventory-deepseek/src/index.ts:31`](../packages/llm/plugin-package-inventory-deepseek/src/index.ts)
...
來源：[`packages/shell/pwsh-local/src/index.ts:58`](../packages/shell/pwsh-local/src/index.ts)
...
依賴：[`LocalConfig`](#deepseek-aidsh-pwsh-local)

來源：[`packages/shell/pwsh-sandbox/src/index.ts:40`](../packages/shell/pwsh-sandbox/src/index.ts)
...
來源：[`packages/guard/repeat-tool-reminder/src/index.ts:28`](../packages/guard/repeat-tool-reminder/src/index.ts)
...
來源：[`packages/sandbox/sandbox-local/src/index.ts:44`](../packages/sandbox/sandbox-local/src/index.ts)
...
依賴：[`SandboxMode`](subsystems/sandbox.zh.md)

來源：[`packages/sandbox/sandbox-policy/src/index.ts:70`](../packages/sandbox/sandbox-policy/src/index.ts)
...
來源：[`packages/bundle/sdk-app/src/index.ts:23`](../packages/bundle/sdk-app/src/index.ts)
...
依賴：`Readable`（`node:stream`）· `Writable`（`node:stream`）

來源：[`packages/sdk/server/src/index.ts:25`](../packages/sdk/server/src/index.ts)
...
來源：[`packages/session/session-log-deepseek/src/index.ts:38`](../packages/session/session-log-deepseek/src/index.ts)
...
來源：[`packages/session-query/session-log-export/src/index.ts:46`](../packages/session-query/session-log-export/src/index.ts)
...
來源：[`packages/session/session-persistence-jsonl/src/index.ts:88`](../packages/session/session-persistence-jsonl/src/index.ts)
...
來源：[`packages/session/session-projection-cache/src/index.ts:63`](../packages/session/session-projection-cache/src/index.ts)
...
依賴：[`SessionQueryConfig`](../packages/session-query/session-query/src/index.ts)

來源：[`packages/session-query/session-query-sqlite/src/index.ts:92`](../packages/session-query/session-query-sqlite/src/index.ts)
...
來源：[`packages/context/session-reference/src/config.ts:11`](../packages/context/session-reference/src/config.ts)
...
依賴：`BatchLogRecordProcessorOptions`（`@opentelemetry/sdk-logs`）· `OTLPExporterNodeConfigBase`（`@opentelemetry/otlp-exporter-base`）

來源：[`packages/session/session-telemetry-otel/src/index.ts:100`](../packages/session/session-telemetry-otel/src/index.ts)
...
來源：[`packages/session/session-title/src/index.ts:56`](../packages/session/session-title/src/index.ts)
...
依賴：[`SessionTitleLlmConfig`](../packages/session/session-title-llm/src/index.ts)

來源：[`packages/session/session-title-all-prompts-llm/src/index.ts:15`](../packages/session/session-title-all-prompts-llm/src/index.ts)
...
來源：[`packages/session/session-title-first-prompt-llm/src/index.ts:15`](../packages/session/session-title-first-prompt-llm/src/index.ts)
...
來源：[`packages/settings/settings-file/src/index.ts:22`](../packages/settings/settings-file/src/index.ts)
...
來源：[`packages/shell/shell-env/src/index.ts:28`](../packages/shell/shell-env/src/index.ts)
...
來源：[`packages/skill/skill/src/index.ts:278`](../packages/skill/skill/src/index.ts)
...
來源：[`packages/skill/skill-filesystem/src/index.ts:49`](../packages/skill/skill-filesystem/src/index.ts)
...
來源：[`packages/spill/spill-local/src/index.ts:31`](../packages/spill/spill-local/src/index.ts)
...
來源：[`packages/spill/spill-policy/src/index.ts:61`](../packages/spill/spill-policy/src/index.ts)
...
來源：[`packages/storage/storage-domain/src/index.ts:52`](../packages/storage/storage-domain/src/index.ts)
...
來源：[`packages/storage/storage-json/src/index.ts:28`](../packages/storage/storage-json/src/index.ts)
...
來源：[`packages/storage/storage-sqlite/src/index.ts:24`](../packages/storage/storage-sqlite/src/index.ts)
...
來源：[`packages/subagent/subagent-acp/src/index.ts:27`](../packages/subagent/subagent-acp/src/index.ts)
...
來源：[`packages/subagent/subagent-claude-code/src/index.ts:38`](../packages/subagent/subagent-claude-code/src/index.ts)
...
來源：[`packages/subagent/subagent-codex/src/index.ts:36`](../packages/subagent/subagent-codex/src/index.ts)
...
來源：[`packages/subagent/subagent-dsh-sdk/src/index.ts:34`](../packages/subagent/subagent-dsh-sdk/src/index.ts)
...
來源：[`packages/subagent/subagent-fork-in-process/src/index.ts:31`](../packages/subagent/subagent-fork-in-process/src/index.ts)
...
來源：[`packages/subagent/subagent-spawn-in-process/src/index.ts:25`](../packages/subagent/subagent-spawn-in-process/src/index.ts)
...
來源：[`packages/e2b/subprocess-e2b/src/index.ts:26`](../packages/e2b/subprocess-e2b/src/index.ts)
...
來源：[`packages/core/system-prompt/src/index.ts:242`](../packages/core/system-prompt/src/index.ts)
...
來源：[`packages/terminal/terminal-bash/src/config.ts:10`](../packages/terminal/terminal-bash/src/config.ts)
...
來源：[`packages/context/time-context/src/index.ts:48`](../packages/context/time-context/src/index.ts)
...
來源：[`packages/context/tmux-context/src/index.ts:36`](../packages/context/tmux-context/src/index.ts)
...
來源：[`packages/llm/token-meter/src/types.ts:13`](../packages/llm/token-meter/src/types.ts)
...
來源：[`packages/shell/tool-bash/src/index.ts:33`](../packages/shell/tool-bash/src/index.ts)
...
來源：[`packages/shell/tool-bash-persistent/src/index.ts:435`](../packages/shell/tool-bash-persistent/src/index.ts)
...
來源：[`packages/fs/tool-fs/src/index.ts:25`](../packages/fs/tool-fs/src/index.ts)
...
來源：[`packages/fs/tool-fs-search/src/index.ts:73`](../packages/fs/tool-fs-search/src/index.ts)
...
來源：[`packages/goal/tool-goal/src/index.ts:25`](../packages/goal/tool-goal/src/index.ts)
...
來源：[`packages/jobs/tool-jobs/src/index.ts:31`](../packages/jobs/tool-jobs/src/index.ts)
...
來源：[`packages/lsp/tool-lsp/src/index.ts:57`](../packages/lsp/tool-lsp/src/index.ts)

<a id="deepseek-aidsh-tool-present"></a>

## `@deepseek-ai/dsh-tool-present`

依賴： `tools` · `fs` · `sessionProjections`
...
來源： [`packages/fs/tool-present/src/index.ts:15`](../packages/fs/tool-present/src/index.ts)
...
來源：[`packages/shell/tool-pwsh/src/index.ts:51`](../packages/shell/tool-pwsh/src/index.ts)
...
來源：[`packages/shell/tool-pwsh-persistent/src/index.ts:472`](../packages/shell/tool-pwsh-persistent/src/index.ts)
...
來源：[`packages/workflow/tool-ralph/src/index.ts:21`](../packages/workflow/tool-ralph/src/index.ts)
...
來源：[`packages/session-query/tool-session-query/src/index.ts:28`](../packages/session-query/tool-session-query/src/index.ts)
...
來源：[`packages/skill/tool-skill/src/index.ts:61`](../packages/skill/tool-skill/src/index.ts)
...
來源：[`packages/fs/tool-str-replace-editor/src/index.ts:505`](../packages/fs/tool-str-replace-editor/src/index.ts)
...
依賴：[`AgentOptions`](subsystems/core.zh.md)

來源：[`packages/subagent/tool-subagent/src/index.ts:48`](../packages/subagent/tool-subagent/src/index.ts)
...
來源：[`packages/terminal/tool-terminal/src/index.ts:35`](../packages/terminal/tool-terminal/src/index.ts)
...
來源：[`packages/todo/tool-todo/src/index.ts:29`](../packages/todo/tool-todo/src/index.ts)
...
來源：[`packages/web/tool-web/src/index.ts:37`](../packages/web/tool-web/src/index.ts)
...
來源：[`packages/workflow/tool-workflow/src/index.ts:32`](../packages/workflow/tool-workflow/src/index.ts)
...
來源：[`packages/core/tools/src/index.ts:647`](../packages/core/tools/src/index.ts)
...
來源：[`packages/typert/loader/src/index.ts:47`](../packages/typert/loader/src/index.ts)
...
來源：[`packages/interaction/user-approval/src/index.ts:128`](../packages/interaction/user-approval/src/index.ts)
...
來源：[`packages/web/web/src/index.ts:55`](../packages/web/web/src/index.ts)
...
來源：[`packages/bundle/web-app/src/index.ts:44`](../packages/bundle/web-app/src/index.ts)
...
來源：[`packages/web/web-fetch-http/src/index.ts:32`](../packages/web/web-fetch-http/src/index.ts)
...
來源：[`packages/web/web-search-deepseek/src/index.ts:46`](../packages/web/web-search-deepseek/src/index.ts)
...
來源：[`packages/web/web-search-exa/src/index.ts:35`](../packages/web/web-search-exa/src/index.ts)
...
來源：[`packages/web/web-search-perplexity/src/index.ts:30`](../packages/web/web-search-perplexity/src/index.ts)
...
來源：[`packages/webhook/webhook-github/src/index.ts:17`](../packages/webhook/webhook-github/src/index.ts)
...
來源：[`packages/workflow/workflow-worker-thread/src/index.ts:32`](../packages/workflow/workflow-worker-thread/src/index.ts)

## 無配置的可加載插件

這些插件通過 `cordis.yml` 中不含 `config:` 塊的條目加載；它們未聲明任何配置接口。
...
抽象服務類——部署時應改為加載具體的實現包（參見[能力 seam](../.agents/notes/implemented/architecture/2026-06-13-capability-seams.zh.md)）。
