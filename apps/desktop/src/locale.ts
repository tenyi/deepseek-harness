...
export const zh = {
  application: '應用',
  startupFailed: 'DeepSeek Harness 無法啟動',
  startupLoading: '正在啟動 DeepSeek Harness…',
  startupLoadingDescription: '準備就緒后將自動打開工作區。',
  startupErrorDescription: '請選擇下方的恢復操作。禁用第三方插件會保留插件文件。',
  startupReinstallAdvice: '如果應用文件缺失或損壞，請關閉應用并重新安裝。任務數據存儲在獨立位置。',
  startupConfigurationAdvice: '重置 Desktop 會刪除桌面端的全部 profile 配置和第三方插件，不保留備份，然后重新初始化并啟動。共享任務和設置會保留。',
  restartApplication: '關閉并重啟',
  resetConfiguration: '重置 Desktop 并重試',
  disableThirdPartyPlugins: '禁用全部第三方插件并重試',
  pluginsMenu: '桌面插件…',
  pluginsMenuPackagedOnly: '桌面插件…（打包應用中可用）',
  checkUpdatesMenu: '檢查更新…',
  updateCheckFailedTitle: '更新檢查失敗',
  unknownError: '未知錯誤',
  updateCheckTitle: '檢查更新',
  updateCurrent: '當前已是最新版本。',
  updateTitle: 'DeepSeek Harness 更新',
  updateAvailable: '發現可用更新',
  updateDetail: 'DeepSeek Harness {version}\n\n新版本綁定匹配的 dsh，安裝后將重新啟動。',
  installAndRestart: '安裝并重啟',
  later: '稍后',
  updateFailedTitle: '更新失敗',
  pluginManagerTitle: '桌面插件',
  pluginWindowTitle: 'DeepSeek Harness — 桌面插件',
  pluginManagerDescription: '插件只安裝到桌面端自己的 node_modules，并由內置 pnpm 管理。',
  refresh: '刷新',
  enable: '啟用',
  disable: '禁用',
  disabled: '已禁用',
  retry: '重試啟動',
  disableAll: '禁用全部插件并重試',
  recoveryDescription: '后端無法啟動。請更新或禁用不兼容插件，然后重試。已安裝插件和配置會保留。',
  changingActivation: '正在更改插件啟用狀態…',
  npmPackage: 'npm 包',
  install: '安裝',
  installed: '已安裝',
  noPlugins: '還沒有安裝桌面插件。',
  remove: '移除',
  update: '更新',
  targetVersion: '輸入 {name} 的目標版本',
  removing: '正在移除 {name}…',
  updating: '正在更新 {name}…',
  installing: '正在安裝 {spec}…',
  operationComplete: '操作完成，桌面后端已重新啟動。',
  refreshing: '正在刷新…',
  refreshed: '插件列表已刷新。',
  loadingPlugins: '正在讀取桌面插件…',
